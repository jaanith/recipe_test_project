package com.recipe.recipetest.bootstrap;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        try {
            ...
            //Check if necessary units are present!
            ...
            //Check if necessary categories are present!
            ...
            guacamoleNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with " +
                    ...
                    "peaches in it (a Diana Kennedy favorite). Try guacamole with added pineapple, mango, or " +
                    "strawberries.\n" +
            ...
            guacRecipe.addNote(guacamoleNotes);
            ...
            tacosRecipe.setDirections("1 Prepare a gas or charcoal grill for medium-high, direct heat.\n" +
                    ...
                    "inserted into the thickest part of the meat registers 165F. Transfer to a plate and rest " +
                    "for 5 minutes.\n" +
    ...
    private UnitOfMeasure getUnitOfMeasure(String description) {
        Optional<UnitOfMeasure> requestedUnit = unitOfMeasureRepository.findByDescription(description);
        if (!requestedUnit.isPresent()) {
            throw new RuntimeException("Requested unit of measurement of \"" + description + "\" is not present!");
        }
        return requestedUnit.get();
    }

    private Category getCategory(String name) {
        Optional<Category> requestedCategory = categoryRepository.findByDescription(name);
        if (!requestedCategory.isPresent()) {
            throw new RuntimeException("Requested category of \"" + name + "\" is not present!");
        }
